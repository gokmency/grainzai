        ...
        <PanelResizeHandle className="resize-handle group relative">
          {!isChatCollapsed && (
            <div className="absolute left-1 top-1/2 z-50 -translate-y-1/2 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
              <Button
                variant="ghost"
                className="rounded-l-none rounded-r-lg border-b border-r border-t border-gray-200/20 bg-grainz-bg-secondary-dark p-2 text-grainz-text-primary transition-colors dark:border-gray-800 [@media(hover:hover)]:hover:bg-grainz-neutral-950 [@media(hover:hover)]:hover:text-grainz-neutral-10"
          ...
          {isChatCollapsed && (
            <div className="absolute left-0 top-1/2 z-50 -translate-y-1/2">
              <Button
                ...
                className="flex h-[100px] w-9 flex-col items-center rounded-l-none rounded-r-lg bg-grainz-bg-secondary-dark px-1.5 py-2 text-grainz-text-primary"
              >
            ...
            <PanelResizeHandle className="resize-handle group relative">
              {!isParametersPanelCollapsed && (
                <div className="absolute right-1 top-1/2 z-50 -translate-y-1/2 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                  <Button
                    variant="ghost"
                    className="rounded-l-lg rounded-r-none border-b border-l border-t border-gray-200/20 bg-grainz-bg-secondary-dark p-2 text-grainz-text-primary transition-colors dark:border-gray-800 [@media(hover:hover)]:hover:bg-grainz-neutral-950 [@media(hover:hover)]:hover:text-grainz-neutral-10"
              ...
              {isParametersPanelCollapsed && (
                <div className="absolute right-0 top-1/2 z-50 -translate-y-1/2">
                  <Button
                    ...
                    className="flex h-[140px] w-9 flex-col items-center rounded-l-lg rounded-r-none bg-grainz-bg-secondary-dark p-2 px-1.5 py-2 text-grainz-text-primary"
                  >

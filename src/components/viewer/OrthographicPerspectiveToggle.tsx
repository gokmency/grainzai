    ...
    <div className="flex items-center gap-2">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="cursor-help">
              <PerspectiveCube className="h-4 w-4 text-grainz-text-primary" />
            </div>
          </TooltipTrigger>
          <TooltipContent
            side="top"
            className="border-grainz-neutral-700 bg-grainz-background-2 text-grainz-text-primary"
          >
      ...
      <TooltipProvider delayDuration={300}>
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="cursor-help">
              <OrthographicCube className="h-4 w-4 text-grainz-text-primary" />
            </div>
          </TooltipTrigger>
          <TooltipContent
            side="top"

      ...
      <AnimatePresence mode="wait" initial={false}>
        {isEditingTitle ? (
          ...
          >
            <div className="flex h-8 w-full items-center gap-2">
              <Input
                ref={inputRef}
                className={cn(
                  'h-8 w-full bg-transparent px-2 text-left text-[17px] font-medium leading-tight tracking-tight text-grainz-neutral-10 selection:bg-grainz-blue/50 selection:text-white',
                  'rounded-none border-x-0 border-b-2 border-t-0 border-grainz-neutral-500',
                  'focus:border-grainz-neutral-500 focus:outline-none focus:ring-0',
                )}
                value={titleInput}
          ...
          <motion.div
            ...
            {...animationProps}
          >
            <div className="flex h-8 w-fit items-center rounded font-medium tracking-tight text-grainz-neutral-10 transition-colors duration-200 hover:bg-black hover:text-grainz-neutral-0">
              <span
                className={cn(

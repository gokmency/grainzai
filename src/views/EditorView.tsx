...
export default function EditorView() {
  ...
  if (isConversationLoading) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-grainz-bg-secondary-dark text-grainz-text-primary">
  ...
  if (!conversation.id) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center bg-grainz-bg-secondary-dark text-grainz-text-primary">
